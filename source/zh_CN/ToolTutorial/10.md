...
<iframe src='../../Sample/viewer_en.html#10_02_Sample/effect1-1.efk'></iframe>
<p>The effect No.1 created in this chapter</p>
</div>

<div align="center" class='col-md-4'>
<iframe src='../../Sample/viewer_en.html#10_02_Sample/effect1-2.efk'></iframe>
<p>The effect No.2 created in this chapter</p>
</div>


<div align="center" class='col-md-4'>
<iframe src='../../Sample/viewer_en.html#10_02_Sample/effect2.efk'></iframe>
...
The parent node rotates and the child nodes move along it to represent the sword.
The following is a simple movie. Red is the parent node's particle and green is the child node's particles.
...
The sword rotates to an angle of 0 degrees when it is generated and 180 degrees when it is finished.
So, in the rotation window, the rotation to be 180 degrees from 0 degrees with easing.
