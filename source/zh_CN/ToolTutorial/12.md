# 12. Let's specify complicated movement with F-Curve!
...
To delete a control point, double-click the control point or push delete.
...
#### About the Timeline (since 1.5)

In Effekseer 1.5, you can now select the mode of timeline.
You can set a value for the lifetime of the effect, or directly set a value for time.
